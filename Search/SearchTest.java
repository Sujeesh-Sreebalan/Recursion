...
class SearchTest {
	...
	public void linearSearchTest3(){
		...
		int size = -1;
		int key = 10;
		AssertionError exception = assertThrows(AssertionError.class, () -> Search.linearSearch(arr, key, size));
	...
	public void binarySearchTes2() {
		...
		int n = arr.length;
		int key = 10;
		assertEquals(-1, Search.binarySearch(arr, key, 0, size, n));
	}
	...
	public void binarySearchTes3(){
		...
		int n = -1;
		int key = 10;
		AssertionError exception = assertThrows(AssertionError.class, () -> Search.binarySearch(arr, key, 0, size, n));
		assertEquals("Enter size the greater than zero", exception.getMessage());
	}
